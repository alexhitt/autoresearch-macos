...
WINDOW_PATTERN = "SLSL"  # sliding window pattern: alternate short/long attention

# Optimization
TOTAL_BATCH_SIZE = 2**15 # ~32K tokens per optimizer step (half batch for more steps)
